            ...
            <div class="col-4">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <button type="button" class="w-100 btn btn-lg btn-outline-primarybtn btn-success">Купить
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample1">
                    <div class="card card-body">
                        Выберете товар, положите в корзину, завершите оформление.
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample2">
                    <div class="card card-body">
                        Доставка бесплатно по России и США.
                    </div>
                </div>
            </div>
            <div class="col">
